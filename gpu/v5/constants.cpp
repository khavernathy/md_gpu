...
Constants::Constants() {
	...
	sigs["H"] = 2.886*cA; // Rappe=2.886; I changed to 0.5 for water model; 0.3 for MOF5.
	sigs["He"] = 2.362*cA;
	sigs["Li"] = 2.451*cA;
	sigs["Be"] = 2.745*cA;
	sigs["B"] = 4.083*cA;
	sigs["N"] = 3.66*cA;
	sigs["O"] = 3.5*cA; // Rappe=3.5; I changed to 1.5 for water model (SPC = 3.166); 1.3 for MOF5
	sigs["F"] = 3.364*cA;
	sigs["Ne"] = 3.243*cA;
	sigs["Xe"] = 4.404*cA;
